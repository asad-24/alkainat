                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <DialogFooter>
                        <Button
                            ...
                            onClick={handleClose}
                            disabled={loading}
                            className="cursor-pointer border-white/20 text-slate-300 hover:bg-slate-800/50 hover:text-white"
                        >
                            Cancel
                        </Button>
                        <Button
                            type="submit"
                            disabled={loading}
                            className="cursor-pointer bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white border-0"
                        >
